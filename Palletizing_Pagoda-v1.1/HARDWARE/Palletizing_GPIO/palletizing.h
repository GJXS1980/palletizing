...
#define MOTO_X_Reversal  	GPIO_ResetBits(GPIOD,GPIO_Pin_5)  
#define MOTO_X_Forward 	GPIO_SetBits(GPIOD,GPIO_Pin_5)

#define MOTO_Y_Reversal  	GPIO_ResetBits(GPIOD,GPIO_Pin_6)  
#define MOTO_Y_Forward 	GPIO_SetBits(GPIOD,GPIO_Pin_6)

#define MOTO_Z_Reversal  	GPIO_ResetBits(GPIOD,GPIO_Pin_7)  
#define MOTO_Z_Forward 	GPIO_SetBits(GPIOD,GPIO_Pin_7)

#define Grab_Up 	GPIO_SetBits(GPIOB,GPIO_Pin_3)  
#define Put_Down 	GPIO_ResetBits(GPIOB,GPIO_Pin_3)  


#define LIMIT_X 	GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_0)
#define LIMIT_XX 	GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_1)
#define LIMIT_Y 	GPIO_ReadInputDataBit(GPIOD,GPIO_Pin_9)
#define LIMIT_YY 	GPIO_ReadInputDataBit(GPIOD,GPIO_Pin_10)
#define LIMIT_U 	GPIO_ReadInputDataBit(GPIOD,GPIO_Pin_1)   //X06
#define LIMIT_UU 	GPIO_ReadInputDataBit(GPIOD,GPIO_Pin_0)   //X07

//原点
#define EXTI_X 	GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_15)
#define EXTI_Y 	GPIO_ReadInputDataBit(GPIOC,GPIO_Pin_4)
#define EXTI_Z 	GPIO_ReadInputDataBit(GPIOD,GPIO_Pin_10)

//指示灯
#define RED_ON  			GPIO_SetBits(GPIOE,GPIO_Pin_0)
#define RED_OFF  			GPIO_ResetBits(GPIOE,GPIO_Pin_0)
#define YELLOW_ON  		GPIO_SetBits(GPIOB,GPIO_Pin_7)
#define YELLOW_OFF  	GPIO_ResetBits(GPIOB,GPIO_Pin_7)
